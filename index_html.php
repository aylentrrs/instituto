...
<script type="text/javascript">
        function confirmar(){
            return confirm('¿Estás seguro? Se eliminarán los datos del alumno');
        }
    </script>
    <meta charset="UTF-8">
...
color: #000;; border-top: 0px solid transparent;
text-align: center; }
#caja{
...
<table>
  <thead>
    <tr>
      ...
      <th>Grupo</th>
      <th>Especialidad</th>
      <th><a class='btn' href="nuevo.php">Agregar</a></th>
    </tr>
  </thead>
  <tbody>
    <?php
    while ($filas = mysqli_fetch_assoc($resultados)) {
      ...
      echo "<td>" . $filas['especialidad'] . "</td>";
      echo "<td><a class='Btn' href='editar.php?id=" . $filas['id'] . "'>Editar 
      ...
      echo "<td><a class='btn1' href='eliminar.php?id=" . $filas['id'] . "' onclick='return confirmar()'>Eliminar</a></td>";
      echo "</tr>";
    }
    ?>
  </tbody>
